...
public class BankTest {
    ...
    public void setNumber_count() throws ExceptionContExist {
        ...
        Client client1 = new Client("Jardiel silva ferreira","000.000.200-03","0110 013 000000-1",12000);

        Bank bank = new Bank("0000 000 000000-9", client.getName(), client.getCpf(), client.getSaldo());

        Bank bank2 = new Bank("0050 013 000000-8",client1.getName(), client1.getCpf(), client1.getSaldo());
